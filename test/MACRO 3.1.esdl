...
<esdl:EnergySystem xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:esdl="http://www.tno.nl/esdl" id="3beab53e-f956-45ac-9fd0-05ba03fb3b84" name="Solar panel" description="Solar panel" esdlVersion="v2102" version="16">
  <instance xsi:type="esdl:Instance" id="1cb40fb5-7c19-43b0-b88d-406aaaf2fbd3">
    ...
    <area xsi:type="esdl:Area" id="nl2019" name="Nederland">
      ...
      <asset xsi:type="esdl:PVPark" id="c5264359-3bd2-4974-a12f-d9b8ddfbc614" technicalLifetime="25.0" panelEfficiency="0.17" originalIdInSource="energy_power_solar_pv_solar_radiation" surfaceArea="200000" power="20000000.0" name="PVPark_c526">
        <costInformation xsi:type="esdl:CostInformation">
          <investmentCosts xsi:type="esdl:SingleValue" value="17420000.0">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" physicalQuantity="COST" unit="EURO" description="EUR"/>
          </investmentCosts>
        ...
        <port xsi:type="esdl:OutPort" id="ae29e956-805d-4720-a22f-e50f03cdbe48" name="Out"/>
      </asset>
      <asset xsi:type="esdl:PVPark" id="38d09594-9743-4a74-ae70-449b9f7e7c29" technicalLifetime="25.0" panelEfficiency="0.17" originalIdInSource="energy_power_solar_pv_solar_radiation" surfaceArea="200000" power="20000000.0" name="PVPark_38d0">
        <costInformation xsi:type="esdl:CostInformation">
          <investmentCosts xsi:type="esdl:SingleValue" value="17420000.0">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" physicalQuantity="COST" unit="EURO" description="EUR"/>
          </investmentCosts>
        ...
        <port xsi:type="esdl:OutPort" id="db3252f3-4009-42fe-a6e3-faa3e65a4b76" name="Out"/>
      </asset>
