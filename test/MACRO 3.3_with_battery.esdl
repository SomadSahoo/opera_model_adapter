...
<esdl:EnergySystem xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:esdl="http://www.tno.nl/esdl" id="3beab53e-f956-45ac-9fd0-05ba03fb3b84" name="MMvIB Macro use case 3.3" description="MMvIB macro use case version 3.3" esdlVersion="v2102" version="16">
  <instance xsi:type="esdl:Instance" id="1cb40fb5-7c19-43b0-b88d-406aaaf2fbd3">
    ...
    <area xsi:type="esdl:Area" id="nl2019" name="Nederland">
      ...
      <asset xsi:type="esdl:Battery" id="casfd934-5290-41dc-98b4-95a842344741" name="Battery" technicalLifetime="12.0" chargeEfficiency="0.9" capacity="12300000" fillLevel="0.5">
        <geometry xsi:type="esdl:Point" CRS="WGS84" lat="52.091920237373906" lon="5.070706138610841"/>
        <port xsi:type="esdl:InPort" carrier="b2418fd5-d4f8-451f-ae4e-6171b1e71103"  name="In" id="db34035e-cf1b-4eee-8b9a-a5cd978d0c88"/>
      </asset>
      ...
      <asset xsi:type="esdl:GasConversion" id="bb6f51a0-812f-4d9e-b23f-5259c54181d4" power="369.0" efficiency="0.81" technicalLifetime="25.0" type="SMR" originalIdInSource="energy_hydrogen_steam_methane_reformer" name="GasConversion_bb6f">
        <costInformation xsi:type="esdl:CostInformation">
      ...
      <asset xsi:type="esdl:PVPark" id="37e43704-0b9e-49a3-97da-99f25c50ff7e" technicalLifetime="25.0" panelEfficiency="0.17" originalIdInSource="energy_power_solar_pv_solar_radiation" surfaceArea="113328" power="11332800.0" name="PVPark_37e4">
        <costInformation xsi:type="esdl:CostInformation">
          ...
          <marginalCosts xsi:type="esdl:SingleValue" id="f93bd4b0-ac0e-43b0-aa32-f05749fa04e2">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" id="fd953877-77e1-4e88-b5f9-ddef5d0d11e8" perUnit="WATTHOUR" description="Cost in EUR/MWh" perMultiplier="MEGA" unit="EURO" physicalQuantity="COST"/>
          </marginalCosts>
        </costInformation>
        <constraint xsi:type="esdl:RangedConstraint" id="ea241389-19bf-41ac-bf7f-cc676a02a251" description="Power range based on 2 scenario's" attributeReference="power" name="NewRangedConstraint">
          <range xsi:type="esdl:Range" name="NewRange" id="58ea2161-1ca1-4b16-a5a1-c458ea63deae" maxValue="66918.0">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" physicalQuantity="POWER" multiplier="MEGA" unit="WATT" id="af9b6a59-1862-436b-ba43-b70143891e7b"/>
          </range>
        </constraint>
